...
<div class="container">
	...
	<p class="lead">
		Hello! I'm Hayden Pott, a software engineer who loves open source. I have been proramming for
		about 8 years in many different languages, but my favourites are Rust and C.
	</p>
	<p class="lead">
		I write all sorts of software, from very high levels (like this website) to low level embedded
		applications. Some of my favourite projects are featured on my
...
<style>
	...
	.text-field::after {
		content: '_';
		animation: 300ms infinite blink alternate;
	}
